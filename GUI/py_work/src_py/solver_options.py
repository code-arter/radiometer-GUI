#coding: utf-8
"""--------------------------------------------------------------------
 * $Id: solver_options.py 3311 2017-12-07 16:19:50Z bernhard.mayer $
 * 
		...
		rte_solver = option(
			...
			tokens=addLogical( name='Input.rte.solver', 
						logicals = [ 'disort', 'twostr', 'mystic', 'rodents', 'sslidar', 'null',
							'sdisort', 'spsdisort', 'fdisort1', 'fdisort2', 'sos', 'polradtran', 'ftwostr', 'montecarlo', 'tzs', 'sssi', 'sss', 'twostrebe', 'twomaxrnd' ],
						setting='SOLVER_' ),
			parents=['uvspec'],
...
#no_sdisort		)
		...
		self.options = [rte_solver, disort_spherical_albedo,
				number_of_streams,] 				
