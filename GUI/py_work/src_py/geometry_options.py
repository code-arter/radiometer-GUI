#coding: utf-8
"""--------------------------------------------------------------------
 * $Id: geometry_options.py 3243 2016-08-19 10:06:25Z bernhard.mayer $
 * 
...
class setup_geometry_group():
    ...
    def __init__(self):
        ...
        documentation.update(get_surface_documentation())
	...
	altitude = option(
		...
		gui_inputs=(FloatInput(name=u'Input.alt.高度', default='NOT_DEFINED_FLOAT', valid_range=[-1000000.0, 1000000.0]), FloatInput(name=u'Input.alt.步长', valid_range=[0, 1000000.0], optional=True),),
